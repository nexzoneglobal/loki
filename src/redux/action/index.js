...
export const useContarctAction = () => async (dispatch) => {
  const web3 = Getweb3();
  await axios.get("http://137.184.238.77:4750/project/all/active")
  .then(async (res) => {
     try{
...
export const usePendingContarctAction = () => async (dispatch) => {
  const web3 = Getweb3();
  await axios.get("http://137.184.238.77:4750/project/all/pending")
    .then(async (res) => {
      try{
        for (let elem of res.data.msg) {
...
export const useClosingContarctAction = () => async (dispatch) => {
  const web3 = Getweb3();
  await axios.get("http://137.184.238.77:4750/project/all/finished")
    .then(async (res) => {
      try{
        for (let elem of res.data.msg) {
          let tokenAddress = elem.contractAddressDeployed;
