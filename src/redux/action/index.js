...
export const useContarctAction = () => async (dispatch) => {
  const web3 = Getweb3();
  await axios.get("https://app.rcsale.app/project/all/active")
  .then(async (res) => {
     try{
...
export const usePendingContarctAction = () => async (dispatch) => {
  const web3 = Getweb3();
  await axios.get("https://app.rcsale.app/project/all/pending")
    .then(async (res) => {
      try{
        for (let elem of res.data.msg) {
...
export const useClosingContarctAction = () => async (dispatch) => {
  const web3 = Getweb3();
  await axios.get("https://app.rcsale.app/project/all/finished")
    .then(async (res) => {
      try{
        for (let elem of res.data.msg) {
          let tokenAddress = elem.contractAddressDeployed;
