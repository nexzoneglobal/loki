...
const AdminProject = () => {
    ...
    const [allfeatured, getallfeatured] = useState([]);
    ...
    const getAlldata = async () => {
        try {
            ...
            await axios.get("http://192.168.18.40:4750/project/all")
                .then((response) => {
    ...
    const approveKyc= async()=>{
        try {
            ...
            await axios.post("http://192.168.18.40:4750/project/approveKYCStatus", {id:ApproveId, status:Approvestatus})
                .then((response) => {
    ...
    const uploadTrending= async ()=>{
        try {
            ...
            await axios.post("http://192.168.18.40:4750/featured/addFeatured", {
    ...
    const alltrending= async ()=>{
        try {
            ...
            await axios.get("http://192.168.18.40:4750/featured/getAllFeatured")
                .then((response) => {

                    if (response.data.status) {
                        getallfeatured(response.data.data)
                    }
                });
                                                    ...
                                                    <tr index={key}>
                                                        ...
                                                        <td className='text-left-normal'>
                                                            <label class="switch" data-toggle="modal" data-target="#exampleModal">
                                                                <input type="checkbox" value={elem.kycVerified}  onChange={(event) => handleChangeEvent(event.target.value, id)}/>
                                                                                    ...
                                                                                    <div className="inner-side-content text-center pt-40">
                                                                                        ...
                                                                                        <ul className="list-inline pt-20">
                                                                                            <li className="list-inline-item">
                                                                                                <button type="button" class="buttion-on"  onClick={approveKyc} >Approve</button>
                                                                                            </li>
                                                                                            <li className="list-inline-item">
                                                    ...
                                                    <h4>Upload Image</h4>
                                                                ...
                                                                return <p className="inputErrors">{maxallo[key]}</p>
                                                                            ...
                                                                            <div className="buttonsff">
                                                                                <button   onClick={uploadTrending} >Save</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="projects-table-main">
                                        <div class="table-responsive button-table">
                                            <table class="table table-clr table-striped text-center">
                                                ...
                                                <tbody className="main-t-body-text" >
                                                {allfeatured.map((elem, key) => {
                                                       const  {id}  = elem;
                                                       return (
                                                    <tr index={key}>
                                                        <td className=''>
                                                            <span className="main-image-dhgy"><img src={elem.image} style={{ width: 40 }} className="main-image-dhgy mr-2" alt="" />{elem.name}
                                                            </span>
                                                        </td>
                                                        <td className='text-left-normal'>
                                                            <h6>{elem.symbol}</h6>
                                                                ...
                                                                return <p className="inputErrors">{minallo[key]}</p>
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        class="form-control" id="example" aria-describedby="text" placeholder="Enter Project URL" />
                                                                                    {/* {Object.keys(maxallo).map((key) => {
                                                                console.log("key", key);
                                                                return <p className="inputErrors">{maxallo[key]}</p>
                                                            })} */}
