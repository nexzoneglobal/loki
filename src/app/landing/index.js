    ...
    <div className='landing-nft'>
              ...
              <div className="row">
                  ...
                  <div className="col-lg-6">
                      <div className="banner-head">
                        ...
                        <a href="/createtoken" className="hero-button" type="button" >Create Token</a>
                      </div>
                  </div>
                  <div className="col-lg-4">

                    <div class="heroimg">
                        <img data-aos="float" data-aos-delay="900" src={require("../../static/images/landing-leocorn/hamicoin.svg")} alt="img" class="aos-init aos-animate" />
                    </div>
      ...
      <section className="featured-pool-closed">
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-1"></div>
            <div className="col-lg-10 trending-head">
      ...
      <section className="featured-pool-closed">
        <div className="container">
          ...
          <div className="searchContainer">
            <input className="searchBox" type="search"
              name="search" placeholder="Search Pool Closed" onChange={(e) => setSearchTerm(e.target.value)} />
            <div className="main-search-ison">
              <i class="fa fa-search " aria-hidden="true"></i>
            </div>
          </div>
          <div className="row main-pool-featured">
            ...
            {closestore.filter((elem,closeindex) => {
              if (searchTerm === "") {
                return elem
