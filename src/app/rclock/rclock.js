    ...
    return (
        <>
            ...
            <div className='landing-nft projects'>
                ...
                <section className="header-section submit-projects pt-120" >
                                        ...
                                        <div className="inner-submit-upper-div1">
                                            <div className="row  ">
                                                <div className="searchbar">
                                                    ...
                                                    <p className='valide alert alert-info'>* To make sure there will be no issues during the transaction, please exclude all reward and tax fee from this contract "0xf89936E90d08C13E84d0832246B09BbeeCee5d92" </p>
